class ColumnasTransposicion {
  /// Método para cifrar texto usando transposición por columnas
  /// [texto] es el texto a cifrar
  /// [numColumnas] es el número de columnas de la matriz (clave)
  /// [caracterRelleno] es el carácter usado para rellenar espacios vacíos
  String cifrar(String texto, int numColumnas, String caracterRelleno) {
    // Trabajamos con el texto tal cual, incluyendo espacios
    int longitud = texto.length;

    // Calcular el número de filas necesarias
    int numFilas = (longitud / numColumnas).ceil();
    ...
    // Llenar la matriz por filas con el texto (incluyendo espacios)
    int indice = 0;
  ...
  /// Método para descifrar texto usando transposición por columnas
  ...
  String descifrar(
    ...
    // Llenar la matriz por columnas con el texto cifrado
    int indice = 0;
    for (int columna = 0; columna < numColumnas; columna++) {
      for (int fila = 0; fila < numFilas; fila++) {
        if (indice < longitud) {
